...
const HomePage = () => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative w-full">
        ...
        <div className="relative px-2 sm:px-6 lg:px-12 py-20 lg:py-28 w-full grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
          <div className="text-center md:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-[rgb(var(--text))]">
              Cemilan Enak,{" "}
              <span className="text-gradient">Mood Meningkat</span>.
            </h1>
            <p className="mt-5 text-[rgb(var(--text-muted))] text-lg max-w-xl mx-auto md:mx-0">
            ...
            <div className="mt-8 grid grid-cols-3 gap-6 max-w-md mx-auto md:mx-0">
              <div className="text-center">
                ...
                <p className="text-[rgb(var(--text-muted))] text-xs font-medium">
                  Merek
                </p>
              </div>
              <div className="text-center">
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-80 h-80">
              ...
              <div className="relative w-full h-full bg-surface rounded-3xl shadow-lg flex items-center justify-center overflow-hidden border border-base">
                <img
                  src={logo}
                  alt="Billsnack"
      ...
      <section className="bg-surface py-12 w-full">
        <div className="px-2 sm:px-6 lg:px-12 w-full">
          <h2 className="text-3xl font-bold text-center mb-8 text-[rgb(var(--text))]">
            JELAJAHI KATEGORI
          </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 max-w-5xl">
              ...
              <Link href="/shop" className="group">
                <div className="bg-surface-alt rounded-xl p-6 h-48 flex flex-col items-center justify-center hover:shadow-lg transition border border-base">
                  ...
                  <h3 className="text-lg font-bold text-center text-[rgb(var(--text))] group-hover:text-black transition-colors">
                    All
                  </h3>
                </div>
              </Link>
      ...
      <section className="bg-surface py-20 w-full">
        <div className="px-2 sm:px-6 lg:px-12 w-full">
          <h2 className="text-4xl font-bold text-center mb-12 text-[rgb(var(--text))]">
            PRODUK TERBARU
          </h2>
      ...
      <section className="bg-surface py-20 w-full">
        <div className="px-2 sm:px-6 lg:px-12 w-full">
          <h2 className="text-4xl font-bold text-center mb-12 text-[rgb(var(--text))]">TERLARIS</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="bg-surface-alt py-20 w-full">
        <div className="px-2 sm:px-6 lg:px-12 w-full">
          <h2 className="text-4xl font-bold text-center mb-12 text-[rgb(var(--text))]">
            Apa Kata Pelanggan Kami
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-surface p-6 rounded-2xl shadow-lg border border-base">
            ...
            <div className="bg-surface p-6 rounded-2xl shadow-lg border border-base">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-linear-to-r from-pink-500 to-rose-500 rounded-full flex items-center justify-center text-white font-bold text-lg">
                  R
                </div>
                <div className="ml-4">
                  <h4 className="font-semibold text-[rgb(var(--text))]">
